...
class EnderecoController {
  ...
  static async create(req: Request, res: Response) {
    try {
      const { id_usuario, endereco, numero, complemento, bairro, cidade, estado, cep, } = req.body;

      const novoEndereco = await Endereco.create({ id_usuario, endereco, numero, complemento, bairro, cidade, estado, cep, });
