...
export const createEnderecoPedidoSchema = z.object({
  id_pedido: z
    .number({ error: "ID do pedido é obrigatório" })
    .int("ID do pedido deve ser um número inteiro")
    .positive("ID do pedido deve ser um número positivo"),
  ...
  bairro: z
    .string({ error: "Bairro inválido" })
    .trim()
    .max(100, "Bairro muito longo")
    .optional(),
});

export const updateEnderecoPedidoSchema = z.object({
  endereco: z
